...
export async function sendPasswordSetEmail(
  ...
  await postOptionalWebhook(
    ...
    { email, name, set_password_link: setPasswordLink, tenant_name: tenantName, tenant_email: tenantEmail },
    'Password set email',
  );
}
...
export async function sendOtpEmail(
  ...
  await postOptionalWebhook(
    ...
    { email, name, otp_code: otpCode, tenant_name: tenantName, tenant_email: tenantEmail },
    'OTP email',
  );
}
