...
export const NM_SIGNATAIRES = {
  "Baptiste Money": {
    name: "Baptiste Money",
    email: "baptistemoney@nm-prime.com",
    titre: "Président",
  },
  "Jean du Boisdulier": {
    name: "Jean du Boisdulier",
    email: "jeanduboisdulier@nm-prime.com",
...
export function buildKycVars(
  ...
  const nmTitre =
    options.signataireName === "Baptiste Money"
      ? "Président"
  ...
  return {
    ...
    dropbox_path_ldm: options.dropboxPathBase
      ? `${options.dropboxPathBase}/${nomFile}_LDM_${today}.pdf`
      : "",
    dropbox_path_der: options.dropboxPathBase
      ? `${options.dropboxPathBase}/${nomFile}_DER_${today}.pdf`
      : "",
  };
}
